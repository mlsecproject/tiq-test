...
```{r, fig.height=10, fig.width=10, fig.align='center'}
  ...
  outbound.pop = tiq.test.extractPopulationFromTI("public_outbound", c("asnumber", "asname"), 
                                                  date = "20140711",
                                                  select.sources=NULL, split.ti=F)
  inbound.pop = tiq.test.extractPopulationFromTI("public_inbound", c("asnumber", "asname"), 
                                                 date = "20140711",
                                                 select.sources=NULL, split.ti=F)
